		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Panel</span>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<li class="sidebar-item {{ request()->routeIs('admin.product.mange') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.product.mange') }}">
             				 <i class="align-middle" data-feather="shopping-bag"></i> <span class="align-middle">Porduct Manage</span>
            			</a>
					</li>

					<li class="sidebar-item {{ request()->routeIs('admin.product.review') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.product.review') }}">
              				<i class="align-middle" data-feather="star"></i> <span class="align-middle">Riview Manage</span>
            			</a>
					</li>
					...
					<li class="sidebar-item {{ request()->routeIs('admin.history.cart') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.history.cart') }}">
             				 <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Cart</span>
            			</a>
					</li>

					<li class="sidebar-item {{ request()->routeIs('admin.history.order') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.history.order') }}">
					...
					<li class="sidebar-item {{ request()->routeIs('admin.category.create') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.category.create') }}">
              				<i class="align-middle" data-feather="plus-square"></i> <span class="align-middle">Create</span>
            			</a>
					</li>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
					...
					<li class="sidebar-item {{ request()->routeIs('admin.productattr.create') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.productattr.create') }}">
              <i class="align-middle" data-feather="plus-square"></i> <span class="align-middle">Create</span>
            </a>
					</li>

					<li class="sidebar-item {{ request()->routeIs('admin.productattr.manage') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.productattr.manage') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
						</a>
					</li>
					...
					<li class="sidebar-item {{ request()->routeIs('admin.manage.user') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.manage.user') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">User</span>
						</a>
					</li>

					<li class="sidebar-item {{ request()->routeIs('admin.manage.vendor') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.manage.vendor') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">Vendor</span>
						</a>
					</li>

					<li class="sidebar-item {{ request()->routeIs('admin.manage.store') ? "active" : '' }}">
						<a class="sidebar-link" href="{{ route('admin.manage.store') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">Store</span>
						</a>
					</li>
